...
@property(nonatomic,strong) NSString *celioscopy;

@property(nonatomic,strong) UIScrollView *ungracefulness;

@property(nonatomic,strong) UIScrollView *bestripe;

@property(nonatomic,strong) UIView *equipollence;

@property(nonatomic,strong) UILabel *graminology;
@end
